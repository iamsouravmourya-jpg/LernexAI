...
export async function queryGroqTutor(
  ...
  for (const modelName of [model, "llama-3.3-70b-versatile", "llama3-8b-8192", "llama3-70b-8192", "gemma2-9b-it", "mixtral-8x7b-32768", "llama-3.1-8b-instant"]) {
    try {
      ...
      const retryable = errMsg.includes("429") || errMsg.includes("503") || errMsg.includes("rate") || errMsg.includes("model_not_found");
      if (!retryable) {
        continue;
      }
    }
